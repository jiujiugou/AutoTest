...
/// <summary>
/// Outbox Webhook 分发后台服务：周期性从 outbox 表中认领消息，并以 HTTP POST 的形式推送到配置的 Webhook 地址。
/// </summary>
public sealed class OutboxWebhookDispatcherHostedService : BackgroundService
{
    /// <summary>
    /// 分发器使用的 HttpClient 命名实例名称。
    /// </summary>
    ...
    /// <summary>
    /// 初始化 <see cref="OutboxWebhookDispatcherHostedService"/>。
    /// </summary>
    /// <param name="scopeFactory">用于创建作用域，以获取仓储等 scoped 服务。</param>
